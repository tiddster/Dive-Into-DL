...
TRAIN_PATH = "/media/tiddster/新加卷/Dataset/Twitter2013/twitter-2013train-A.tsv"
TEST_PATH = "/media/tiddster/新加卷/Dataset/Twitter2013/twitter-2013test-A.tsv"
BERT_PATH = "/media/tiddster/新加卷/Dataset/Bert-uncased/"
...
from transformers import BertForMaskedLM, BertModel, AdamW
